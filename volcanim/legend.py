...
def create_legend(plane):
    ...
    label_high_lfc_non_sig = Text("|Log2FC| >= 2 & p_val > 0.05", font_size=24).scale(0.65).\
    ...
    label_high_lfc_sig = Text("|Log2FC| >= 2 & p_val <= 0.05", font_size=24).scale(0.65).\
    ...
    label_low_lfc_sig = Text("|Log2FC| < 2 & p_val <= 0.05", font_size=24).scale(0.65).\
